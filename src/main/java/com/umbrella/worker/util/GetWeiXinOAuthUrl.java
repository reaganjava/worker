...
public class GetWeiXinOAuthUrl {
    ...
    public  String getCodeRequest(String orderNo){
        String result = null;
        System.out.println("+++++++++++++++++" + orderNo);
        GetCodeRequest  = GetCodeRequest.replace("APPID", urlEnodeUTF8("wxc419a6155fcf608b"));
        GetCodeRequest  = GetCodeRequest.replace("REDIRECT_URI",urlEnodeUTF8("http://wx.xsh1314.com/pay/oauth.html?orderNo=")  + orderNo);
