...
<body>
<div class="pd-20">
  <form action="${pageContext.request.contextPath}/supplier/edit.json" method="post" class="form form-horizontal" id="form-supplier-edit">
  	<input type="hidden" name="id" value="${SUPPLIER_INFO.id}"/>
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>渠道名：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text"  placeholder="" id="wSName" name="wSName" datatype="*6-30" nullmsg="渠道名不能为空" value='${SUPPLIER_INFO.wSName}'>
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text"  placeholder="" id="wSTelephone" name="wSTelephone"  datatype="n8-15" nullmsg="联系电话不能为空" value='${SUPPLIER_INFO.wSTelephone}'>
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" placeholder="" name="wSContact" id="wSContact" datatype="*3-8" nullmsg="联系人不能为空" value='${SUPPLIER_INFO.wSContact}'>
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
     ...
     <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" placeholder="" name="wSAddress" id="wSAddress" datatype="*" nullmsg="地址不能为空" value='${SUPPLIER_INFO.wSAddress}'>
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" placeholder="" name="wSWebsite" id="wSWebsite" dragonfly="true" value='${SUPPLIER_INFO.wSWebsite}'>
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
