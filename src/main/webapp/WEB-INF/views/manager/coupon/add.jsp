...
<body>
<div class="pd-20">
  <form action="${pageContext.request.contextPath}/coupon/add.json" method="post" class="form form-horizontal" id="form-coupon-add">
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>优惠卷标题：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="wCTitle" name="wCTitle" datatype="*" nullmsg="优惠卷标题不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
     <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" placeholder="" name="wCDesc" id="wCDesc" datatype="*" nullmsg="优惠卷说明不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="wCMoney" name="wCMoney"  datatype="n" nullmsg="优惠卷价值">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="wCDiscount" name="wCDiscount"  datatype="n" nullmsg="优惠卷折扣">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" placeholder="" name="beginTime" id="beginTime" onClick="WdatePicker()" nullmsg="开始发行时间不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
   <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" placeholder="" name="endTime" id="endTime" onClick="WdatePicker()" nullmsg="结束发行时间不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
     <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" placeholder="" name="wCDays" id="wCDays" datatype="n" nullmsg="真实姓名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
     <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" placeholder="" name="wCPublishiCount" id="wCPublishiCount" datatype="n" nullmsg="发行数量不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
