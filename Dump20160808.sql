...
CREATE TABLE `w_worker_task` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `W_W_SUPPLIER` int(11) NOT NULL,
  `W_W_NAME` varchar(30) NOT NULL,
  `W_W_PRICE` int(11) NOT NULL,
  `W_W_PRICE_UNIT` int(11) NOT NULL,
  `W_W_TYPE` int(11) NOT NULL,
...
-- Dump completed on 2016-08-08 10:50:36
