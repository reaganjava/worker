	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th width="40">客户电话</th>
				<th width="40">服务名称</th>
				<th width="90">服务人员姓名</th>
				<th width="180">服务人员电话</th>
				<th width="90">费用</th>
				<th width="70">创建时间</th>
				<th width="100">操作</th>
			</tr>
		...
		<tbody>
		  <c:forEach items="${PAGE_BEAN.dataList}" var="order">
			<tr class="text-c">
				...
				<td>${order.orderDetailDO.wOStaffOneContact}|${order.orderDetailDO.wOStaffTowContact}</td>
				<td>${order.orderDetailDO.wOStaffOneTelephone}|${order.orderDetailDO.wOStaffTowTelephone}</td>
