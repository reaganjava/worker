...
<div class="pd-20">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
		  <c:forEach items="${PAGE_BEAN.dataList}" var="payrecord">
			<tr class="text-c">
				<td><input type="checkbox" value="${payrecord.id}" name="idArray"></td>
				<td>${payrecord.id}</td>
				<td>${payrecord.supplierName}</td>
				<td>人民币：${payrecord.wPAmount} 元</td>
				<td>${payrecord.formatDate}</td>
...
$(function(){
	$('.table-sort').dataTable({
		...
		"aoColumnDefs": [
		  ...
		  {"orderable":false,"aTargets":[0,1,1]}// 制定列不参与排序
		]
	});
